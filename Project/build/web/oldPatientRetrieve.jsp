...
<form method="post" action="OldPatientRegistration_1.jsp">
      <table align="center" border="0">
          ...
          <tbody>
              ...
              <tr>
                  <td align="left"><input type="submit" value="Get Old PatientDetails" name="GetoldPatientDetails" class="phs_Button"/></td>
                  <td align="center" colspan="2"><input type="reset" value="Clear" name="Clear" class="phs_Button"/></td>
              </tr>
          </tbody>
      </table>
      </form>
