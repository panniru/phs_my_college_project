    ...
    <body>
      ...
      <table align="center" border="0">
          <tbody>
              ...
              <tr>
                  <td><input type="submit" value="GenerateID" name="GenerateID" onclick="Window.alert('Doctor Registered Successfully.Visit Hospitsl to get Unique ID..')" class="phs_Button"/></td>
                                    <td align="left"></td>
