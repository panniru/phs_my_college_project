    ...
    <script src="jquery-1.7.2.min.js"></script>
        <script type="text/javascript">
            ...
            function getdate()
            {
                ...
                var url='MedicineIssued?patientId='+patientId+'&date= ';
                alert(url);
            ...
            function addToCart(medicineName,date)
            {
               ...
               alert("cost"+cost)
                ...
                var item=medicineName+":"+date+"_"+iQuanity;
            ...
            {
                alert('Medicines Added Successfully and total Amount'+total);
